...
namespace OfflineSpeechTranslation.ViewModels;

/// <summary>
/// ViewModel for the transcription page. Wraps SpeechTranslationService
/// and exposes commands for the UI.
/// </summary>
public sealed partial class TranscriptionViewModel : ObservableObject
{
    private readonly SpeechTranslationService _service;
    ...
    public SpeechTranslationService Service => _service;

    public TranscriptionViewModel(SpeechTranslationService service, AppPreferences prefs)
    {
        _service = service;
        _prefs = prefs;
        ...
        {
            if (e.PropertyName == nameof(SpeechTranslationService.SessionState))
                IsRecording = _service.SessionState == SessionState.Recording;
        };
    }
